    ...
    <section id="home" className="min-h-screen relative flex flex-col justify-center px-6 md:px-12 lg:px-20 pt-20 pb-20 scroll-mt-20">
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <h2 className="text-xl md:text-3xl lg:text-4xl font-sans font-bold text-gray-200 tracking-wide">
            Kaligotla Sri Datta Sai Vithal
          </h2>

          <h1 className="text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold leading-[1.05] md:leading-[0.95] tracking-tight text-white">
            Creative <br />
            Developer <br />
        ...
        <motion.div
          ...
          className="mt-8 sm:mt-12 md:mt-16 lg:mt-20 relative w-full aspect-video sm:aspect-auto sm:h-[240px] md:h-[320px] lg:h-[400px] xl:h-[480px] rounded-xl sm:rounded-2xl md:rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden bg-brand-card border border-white/5 shadow-2xl"
        >
          ...
          <picture>
            ...
            <img
              ...
              className={`w-full h-full object-contain object-center transition-all duration-[1.5s] grayscale hover:grayscale-0 hover:scale-[1.01] ${imgLoaded ? 'opacity-90 hover:opacity-100' : 'opacity-0'
                }`}
              loading="eager"
              decoding="async"
