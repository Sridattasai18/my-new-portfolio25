      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-tight text-white">
            ...
            <div className="rounded-3xl overflow-hidden border border-white/5 h-64 md:h-96 w-full relative group shadow-lg bg-brand-card">
              <img
                src="https://images.unsplash.com/photo-1509966756634-9c23dd6e6815?q=80&w=800&auto=format&fit=crop"
