      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-20">
          <motion.h2
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6 leading-tight text-white"
          >
                ...
                {category.skills.map((skill) => (
                  ...
                  >
                    {category.title === "Soft Skills" ? (
                      ...
                      <>
                        <div className="w-12 h-12 md:w-14 md:h-14 bg-[#1a1a1a] rounded-xl flex items-center justify-center border border-white/5 group-hover/icon:border-brand-blue/50 group-hover/icon:bg-neutral-800 transition-all duration-300 shadow-sm">
                          {skill.iconUrl ? (
                            <img src={skill.iconUrl} alt={skill.name} className="w-6 h-6 md:w-7 md:h-7 opacity-70 group-hover/icon:opacity-100 transition-opacity transform group-hover/icon:scale-110 duration-300" />
                          ) : (
